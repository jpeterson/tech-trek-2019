...
# [tech-trek-js.netlify.com](https://tech-trek-js.netlify.com/)
...
# How do we feel about JavaScript?
...
<img src="/static/assets/feels_like.png" style={{ height: '75vh' }} />
...
<Invert>
  <iframe
    ...
    scrolling="no"
    title="Editor widget with configurations"
    src={`//codepen.io/jpeterson/embed/oRPNPo/?height="800"&theme-id=dark&default-tab=result`}
    frameBorder="no"
    allowtransparency="true"
    allowFullScreen={true}
  >
    See the Pen{' '}
    <a href="https://codepen.io/jpeterson/pen/oRPNPo/">
...
WAB ➡️ ExB: Future proofing your widgets
...
- [typescriptlang.org/docs/handbook/react-&-webpack.html](https://www.typescriptlang.org/docs/handbook/react-&-webpack.html)
- [basarat.gitbooks.io/typescript/content](https://basarat.gitbooks.io/typescript/content/)
- [github.com/TypeStrong/learn-typescript](https://github.com/TypeStrong/learn-typescript)
- [Official "What's New" Wiki Page](https://github.com/Microsoft/TypeScript/wiki/What%27s-new-in-TypeScript)
...
- [wesbos.com/courses](https://wesbos.com/courses)
...
Last point on working with frameworks...

---

<img src="/static/assets/frameworks.png" />
...
Authentication – save the token for later
...
<Alert yellow> ⚠️ This is not an official product! ⚠️</Alert>
